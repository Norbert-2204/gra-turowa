  ...
  if (selectedHero) {
    ...
    async function createAbilityImplant(
      ...
      if (event.target.classList.contains(selector)) {
        ...
        targetWeakness = weaknessImplant(targetWeakness, element, info);
        if (!targetWeakness) {
          return;
        }

        console.log(targetWeakness, "wynik result");
        console.log(targetWeakness, "toughness po Implant");
        console.log(targetWeakness, "weakness po Implant");
